...
const DEFAULT_CASUALTIES = {
  ...
  israel: { killed: 30, wounded: 6269 },
  usa: { killed: 15, wounded: 332 },
  lebanon: { killed: 1238, wounded: 3543 },
  yemen: { killed: 0, wounded: 0 },
  iraq: { killed: 103, wounded: 212 },
  uae: { killed: 11, wounded: 165 },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-1.5 border-b border-ops-border flex items-center justify-between">
        ...
        <span className="text-ops-muted text-[8px]">MAR 29, 2026</span>
      </div>
