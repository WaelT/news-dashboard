...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+54%', sub: '~$105/bbl (May 21)', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '89%', sub: 'transit disrupted', color: '#ff6600' },
  { label: 'EU Gas Prices', value: '€60', sub: '€60/MWh', color: '#ff6600' },
  { label: 'US Gas Price Rise', value: '+$1.52', sub: '$4.50/gal national avg', color: '#3b82f6' },
  { label: 'Flights Cancelled', value: '78,000+', sub: 'cumulative grounded', color: '#0088cc' },
