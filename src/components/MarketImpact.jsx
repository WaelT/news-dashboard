...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+32%', sub: '~$90/bbl (Aug 17)', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '99%', sub: 'transits vs pre-war', color: '#ff6600' },
