...
const FALLBACK = {
  ...
  brent: { price: 103.40, change: 48.0 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$47B+', sub: '~$1.2B/day (39 days)', color: '#ff0040' },
  ...
  { label: 'Trump', value: '2-WEEK CEASEFIRE', sub: 'postponed "Power Plant Day"; contingent on Iran reopening Hormuz', color: '#0088cc' },
  { label: 'Kharg Island', value: 'STRUCK', sub: 'US begins strikes on Iran main oil export terminal', color: '#ff0040' },
  { label: 'Brent Crude', value: '$103', sub: '/barrel (-6% plunge); ceasefire hopes crash oil from $115', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '96%', sub: '2-week window to reopen; human chains at power plants', color: '#ff0040' },
  { label: 'Bab al-Mandab', value: 'THREATENED', sub: 'Houthis: closure "viable option"; 15% global trade', color: '#ff0040' },
  { label: 'Human Chains', value: 'IRAN', sub: 'civilians surround power plants; Kazerun plant protected', color: '#d4a017' },
  { label: 'Saudi Bridge', value: 'CLOSED', sub: 'King Fahd Causeway to Bahrain shut for security', color: '#ff0040' },
  { label: 'Iran 45-Day', value: 'REJECTED', sub: 'demands permanent end; rejects mediator ceasefire proposal', color: '#ff0040' },
  { label: 'US Wounded', value: '538+', sub: 'Pentagon cover-up; 15 KIA; 7 aircraft lost', color: '#ff0040' },
  { label: 'Iran Navy', value: '92% destroyed', sub: '10,000+ targets; 30+ universities bombed', color: '#0088cc' },
  { label: 'IDF Lebanon', value: 'DEMOLITION', sub: 'All border homes razed; 600K barred; 3 UN KIA', color: '#0088cc' },
  { label: 'Goldman Sachs', value: '$147+', sub: '$200 if Hormuz stays closed; 600M+ barrels at risk', color: '#ff6600' },
  { label: 'US Gas Price', value: '$4.11/gal', sub: 'up from $2.98 pre-war; Italy rationing jet fuel', color: '#ff6600' },
