...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+15%', sub: '~$78/bbl post-deal', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '72%', sub: 'traffic still blocked', color: '#ff6600' },
