...
const FALLBACK = {
  ...
  brent: { price: 109.26, change: 56.0 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$46B+', sub: '~$1.2B/day (38 days)', color: '#ff0040' },
  ...
  { label: 'Trump', value: 'POWER PLANT DAY', sub: 'Apr 7 8pm deadline; "blow everything up"; Iran rejects ceasefire', color: '#ff0040' },
  { label: 'Haifa', value: '4 DEAD', sub: 'bodies recovered from residential building; 10+ sites hit', color: '#ff0040' },
  { label: 'Brent Crude', value: '$109', sub: '/barrel; WTI surpasses Brent at $114; markets chaotic', color: '#ff6600' },
  ...
  { label: 'Tehran', value: '6 CHILDREN KILLED', sub: 'Baharestan residential area; Sharif Univ mosque damaged', color: '#ff0040' },
  { label: 'Bahrain GPIC', value: 'SUSPENDED', sub: 'petrochemical ops halted after drone attack', color: '#ff0040' },
  { label: 'Hegseth', value: 'FIRES GENERALS', sub: 'Army top general + 2 officers; wartime command shake-up', color: '#ff0040' },
  { label: 'Iran 45-Day', value: 'REJECTED', sub: 'demands permanent end; rejects Egyptian/Pakistani/Turkish proposal', color: '#ff0040' },
