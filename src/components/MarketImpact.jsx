...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+24–34%', sub: '~$88–91/barrel', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '99%', sub: 'strait effectively closed', color: '#ff6600' },
