...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+32%', sub: '~$90/bbl — nuclear strikes (Jun 21)', color: '#ff0040' },
  { label: 'Hormuz Disruption', value: '75%', sub: 'transits halted on strikes', color: '#ff0040' },
