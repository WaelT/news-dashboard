...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$35B+', sub: '~$1.2B/day (29 days)', color: '#ff0040' },
  ...
  { label: 'Trump Approval', value: '36%', sub: '"very disappointed" with NATO; says US doesn\'t need it', color: '#ff0040' },
  { label: 'Brent Crude', value: '$113', sub: '/barrel (+61%); WTI breaks $100; Houthi + Bab al-Mandab', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '96%', sub: '~5 ships/day; IRGC toll booth; dual chokepoint risk', color: '#ff0040' },
  { label: 'Bab al-Mandab', value: 'THREATENED', sub: 'Houthis threaten closure; 15% global maritime trade', color: '#ff0040' },
  ...
  { label: 'Kuwait Airport', value: 'HIT', sub: 'fuel depot fire from drone attack', color: '#ff0040' },
  { label: 'Iraq Oil', value: 'HALTED', sub: 'force majeure; 7 soldiers killed by US strike', color: '#ff0040' },
