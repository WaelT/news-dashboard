...
const FALLBACK = {
  ...
  brent: { price: 118.00, change: 68.0 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$34B+', sub: '~$1.4B/day (13 days)', color: '#ff0040' },
  ...
  { label: 'Brent Crude Peak', value: '$126', sub: '/barrel (all-time high)', color: '#ff6600' },
