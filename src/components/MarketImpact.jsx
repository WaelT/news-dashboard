...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+26–29%', sub: '~$85–88/barrel', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '98%', sub: '10 transits/day vs 90', color: '#ff6600' },
