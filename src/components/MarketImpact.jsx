...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+28%', sub: '$87/bbl (peak $126)', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '92%', sub: 'of Hormuz flow blocked', color: '#ff6600' },
  { label: 'EU Gas Prices', value: '€60', sub: '€60/MWh', color: '#ff6600' },
  { label: 'US Gas Price Rise', value: '$4.50/gal', sub: '+$1.35 from pre-war', color: '#3b82f6' },
  { label: 'Flights Cancelled', value: '78,000+', sub: 'cancelled since Feb 28', color: '#0088cc' },
