...
const FALLBACK = {
  ...
  brent: { price: 110.99, change: 59.0 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$44B+', sub: '~$1.2B/day (37 days)', color: '#ff0040' },
  ...
  { label: 'Trump', value: '"LIVING IN HELL"', sub: 'Apr 6 deadline TOMORROW; Iran calls it "stupid action"', color: '#ff0040' },
  { label: 'F-15E WSO', value: 'RESCUED', sub: 'dramatic firefight inside Iran; both crew safe; 7 aircraft lost', color: '#0088cc' },
  { label: 'Brent Crude', value: '$111', sub: '/barrel (+59%); WTI $114; fuel shortages spreading', color: '#ff6600' },
  ...
  { label: 'Mahshahr', value: 'PETROCHEM HIT', sub: '70% of Iran gasoline supply; Borouge Abu Dhabi on fire', color: '#ff0040' },
  { label: 'Haifa Strike', value: '10 INJURED', sub: '4 missing after Iranian missile; IDF unsure of BM inventory', color: '#ff0040' },
