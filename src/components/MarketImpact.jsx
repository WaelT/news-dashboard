...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+13%', sub: '~$77.5/bbl (ceasefire)', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '88%', sub: 'vs pre-war traffic', color: '#ff6600' },
