...
const FALLBACK = {
  ...
  brent: { price: 103.90, change: 48.4 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$30B+', sub: '~$1.2B/day (25 days)', color: '#ff0040' },
  ...
  { label: 'Brent Crude', value: '$104', sub: '/barrel (+49%); peak $126', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '99%', sub: 'near-total; Iran developing vetting system', color: '#ff0040' },
  { label: 'Gulf Output Drop', value: '10M+', sub: 'bbl/day lost; Philippines declares energy emergency', color: '#ff6600' },
  ...
  { label: 'Iran Naval Losses', value: '140+', sub: 'vessels destroyed + 44 minelayers', color: '#0088cc' },
  ...
  { label: 'Global Inflation', value: '+0.8%', sub: 'IEA: worse than 1970s oil shocks', color: '#d4a017' },
];
