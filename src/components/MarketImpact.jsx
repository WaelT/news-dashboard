...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$48B+', sub: '~$1.2B/day (40 days)', color: '#ff0040' },
  ...
  { label: 'Ceasefire', value: 'CRACKING', sub: '2-week truce; Israel Op Eternal Darkness; Iran re-closes Hormuz', color: '#d4a017' },
  { label: 'Kharg Island', value: 'STRUCK', sub: 'US began strikes on Iran main oil export terminal', color: '#ff0040' },
  { label: 'Brent Crude', value: '$95', sub: '/barrel (-16% crash); biggest drop since Apr 2020; Dow best day in year', color: '#2dd4a8' },
  { label: 'Hormuz', value: 'RE-CLOSED', sub: 'Iran halts shipping after Israeli Lebanon strikes; White House denies', color: '#ff0040' },
  ...
  { label: 'Islamabad Talks', value: 'THIS WEEK', sub: 'peace negotiations scheduled; world greets truce with cautious relief', color: '#0088cc' },
  { label: 'US Wounded', value: '538+', sub: 'Pentagon cover-up continues; 15 KIA; 7 aircraft lost', color: '#ff0040' },
  { label: 'Lebanon Total', value: '1,784 KILLED', sub: 'up from 1,530 in 24 hours; Op Eternal Darkness bloodiest day', color: '#ff0040' },
