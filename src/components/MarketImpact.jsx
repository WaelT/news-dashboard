...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$29B+', sub: '~$1.2B/day (24 days)', color: '#ff0040' },
  ...
  { label: 'Hormuz Disruption', value: '99%', sub: 'near-total blockade; 12 mines detected', color: '#ff0040' },
  ...
  { label: 'Lufthansa Suspend', value: 'OCT 2026', sub: 'Middle East flights suspended 7 months', color: '#0088cc' },
