...
const FALLBACK = {
  ...
  brent: { price: 111.69, change: 60.0 },
...
const ECON_DATA = [
  { label: 'US Military Cost', value: '$42B+', sub: '~$1.2B/day (35 days)', color: '#ff0040' },
  ...
  { label: 'Trump $1.5T', value: 'DEFENSE BUDGET', sub: '"assault on infrastructure hasn\'t even started"', color: '#ff0040' },
  ...
  { label: 'Tehran Bridge', value: 'COLLAPSED', sub: 'B1 bridge: 8 killed, 95 wounded; Pasteur Institute bombed', color: '#ff0040' },
  { label: 'UAE Barrage', value: '18 BMs + 47 DRONES', sub: '+ 4 cruise missiles; Abu Dhabi: 1 dead, 16 injured', color: '#ff0040' },
  ...
  { label: 'US Wounded', value: '520+', sub: 'Pentagon cover-up; Israel 6,905 wounded', color: '#ff6600' },
