...
const ECON_DATA = [
  { label: 'Brent Crude Surge', value: '+22–25%', sub: '~$83–85/barrel', color: '#ff6600' },
  { label: 'Hormuz Disruption', value: '98%', sub: 'Strait declared closed', color: '#ff6600' },
