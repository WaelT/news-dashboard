...
const diplomaticEvents = [
  ...
  {
    date: '2026-07-05',
    event: 'Day 128 — Hormuz transits ~64/day; oil flows ~9.5 mbd; Brent ~$56–59/bbl; US gas ~$2.76–2.86/gal (4-yr low)',
    type: 'economic',
    status: 'implemented',
    detail: 'Day 128 of the 2026 Iran war — economic normalization on ceasefire Day 12. Strait of Hormuz tanker transits reached approximately 64 per day (up from 60 on Day 11), continuing the fastest normalization pace since the crisis began. Oil flows through Hormuz reached approximately 9.5 mbd (up from 9.0 mbd on Day 11), representing approximately 52% of the 18.1 mbd pre-war flow level. Saudi Arabia Ras Tanura, UAE ADNOC, and Kuwait KNPC all at full export capacity; Kharg Island Iranian crude exports at approximately 98% pre-war capacity under the US Treasury 60-day authorization — near full pre-war export restoration. Brent crude fell to approximately $56–59/bbl — the lowest since before the conflict began and now well below the $68 pre-war baseline; US average retail gasoline prices fell to approximately $2.76–2.86/gallon, the lowest 4-year level and continuing to decline. VLCC tanker spot rates at $6K–$12K/day — well below pre-war norms of $35K–$50K/day and continuing to fall. Tankers queued outside Hormuz down to approximately 55 (from 65 on Day 11). Houthi ceasefire Day 11: Bab al-Mandab fully open; 23rd consecutive quiet day; all major shipping lines at pre-war Red Sea operational tempo. Goldman Sachs Q4 2026 Brent forecast $80/bbl; IEA projects global oil market surplus of ~1.5 mbd by Q3 2026 (TradingEconomics; CNBC; Goldman Sachs; JMIC; US EIA; Baltic Exchange; July 5).',
  },
];
