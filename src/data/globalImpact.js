...
export const globalImpact = {
  updated: '2026-05-31',
  gdpImpact: [
    { region: 'Iran', flag: 'ir', pct: -22.0, costBn: 0, note: 'Economy near-collapse; IMF forecast: GDP −6.1% for 2026, inflation 68.9%; oil exports halted; revenue loss ~$150M/day (The National, Apr 13); PGSA collecting Hormuz transit fees (up to $2M/ship in CNY); Kharg Island ~71 sq km oil slick; drone production resuming (CIA); internet partially restored after 88-day blackout; Iran in principle agreed to HEU disposal; Khamenei endorsed broad deal template; $24B frozen assets at stake; May 31: FM Baghaei says "no final agreement reached, exchanges continuing"; Ghalibaf: Iran judges deal by actions; deal still awaiting Trump/Khamenei sign-off' },
    { region: 'Israel', flag: 'il', pct: -5.8, costBn: 26, note: 'Finance Ministry initial estimate: NIS 35B (~$11.5B) war cost (ToI Apr 12); ~$3B/week GDP loss; fiscal deficit from 3.9%→5.1% GDP; Lebanon ceasefire extended 45 days (~July 1) — IDF operations north of yellow line continuing; Lebanon toll ~3,324 killed, ~10,027 wounded (updated May 30); Pentagon Lebanon military talks May 29; political talks June 2–3' },
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $25B direct military cost; independent economists: $630B–$1T total (Al Jazeera Apr 30; Harvard Kennedy School); ~$1.1B/day; CENTCOM disables 5th blockade-runner (M/V Lian Star) in Gulf of Oman May 31 — Hellfire missile; Hegseth Shangri-La: "blockade still in place, able to recommence"; Trump to make "final determination" on 60-day MOU; Brent ~$91.12/bbl; gas ~$4.45/gal; political talks June 2–3' },
  ...
  oil: {
    preWar: 68, current: 91, peak: 126, forecast: 82,
    note: 'Brent ~$91.12/bbl (May 31); −17% for May — biggest monthly decline since 2020; WTI ~$88/bbl; CENTCOM fires Hellfire at M/V Lian Star in Gulf of Oman (5th blockade-runner disabled, 116 total redirected); Hegseth Shangri-La Dialogue (May 30): "blockade still in place; Hormuz will be open and toll-free"; Trump to make "final determination" on 60-day MOU; Iran FM Baghaei: "no final agreement, exchanges continuing"; Lebanon toll ~3,336/~10,067 (May 31); ceasefire holds Day 92; PGSA operational; UKMTO 2026-041 in effect; war-risk insurance still 8× pre-crisis',
  },
};
