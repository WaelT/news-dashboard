...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: '~$1.1B/day military; May 21: 5th consecutive ceasefire day; Trump says talks in "final stages" — Brent plunged 5%+ to $105.02 on May 20; WTI fell below $100 ($98.26) for first time since conflict began; Brent stabilized ~$105 May 21; gas ~$4.50/gal (AAA); Pentagon military talks May 29' },
  ...
  oil: {
    ...
    note: 'Brent $105.02/bbl (May 20 close; -5.16% on Trump "final stages" comment; WTI $98.26 — first sub-$100 since conflict began); Brent stabilized ~$105 on May 21; 5th consecutive ceasefire day; 3 supertankers transiting per satellite data; IEA: Hormuz disruption is "largest supply disruption in history of global oil market"; Barakah Unit 3 power restored (IAEA); Lebanon toll 3,039+ killed; Maj. Sapir killed by Hezbollah; Pentagon talks May 29; political talks June 2–3',
  },
};
