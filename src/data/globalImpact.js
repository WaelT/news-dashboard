...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $29B+ direct military cost (Military Times May 12); Moody\'s: $100B household cost (~$750/household); independent economists: $630B–$1T total; Brent $72.12 Friday close (down from $126 peak); Hormuz transits at ~68/day; Rome 60-day follow-on talks paused one week for Khamenei state funeral — Trump: "Iran gets a week off"; Doha indirect talks on $6B Iranian assets goods-purchase mechanism concluded; US-Iran de-confliction cell active via Qatar and Pakistan; CENTCOM escort operations concluded post-MOU; Iran/US/Lebanon High Level Committee established June 30 (Reuters; Fox News; CBS News; GlobalSecurity; July 6)' },
