...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'Israel', flag: 'il', pct: -5.8, costBn: 26, note: 'Mobilization + Lebanon ops + reconstruction; Lebanon ceasefire extended 45 days (to ~July 1) — IDF continues strikes; Lebanon toll ~3,290 killed, ~9,962 wounded (updated May 29); IDF strikes Beirut (Shuwayfat) first time in 3 weeks — Ali al-Husni IRGC Imam Hossein Division missile unit commander killed; IDF strikes Sidon (5 killed/21 wounded), Adloun (family car, 6 killed); IDF operations north of yellow line continuing; Hezbollah drone activity in northern Israel sectors' },
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: '~$1.1B/day military; May 29: US-Iran reach tentative 60-day MOU — Hormuz to reopen (no tolls), Iran clears mines, US lifts blockade + sanctions waivers; Vance: "still TBD" whether Trump signs; Brent ~$96–97/bbl; gas ~$4.45/gal; Pentagon Lebanon military talks May 29; political talks June 2–3' },
  ...
  oil: {
    ...
    note: 'Brent ~$96–97/bbl (easing on deal optimism); WTI ~$91/bbl; US-Iran reach tentative 60-day MOU — Hormuz to reopen (no tolls), Iran clears mines, US lifts blockade + sanctions waivers; Vance: "still TBD" whether Trump signs; IDF strikes Beirut (Shuwayfat) first time in 3 weeks — Ali al-Husni IRGC Imam Hossein Division killed; Lebanon toll ~3,290/9,962; IRGC warning shots at 4 vessels in Hormuz; Pentagon Lebanon military talks convened; political talks June 2–3; war-risk insurance still 8× pre-crisis; PGSA operating; UKMTO 2026-041 in effect',
  },
};
