...
export const globalImpact = {
  ...
  oil: {
    ...
    note: 'Brent ~$90/bbl (June 21, Day 114) — surging sharply after US strikes Fordow, Natanz, and Isfahan nuclear facilities with B-2 bombers + GBU-57 bunker busters + Tomahawks; deal framework in serious doubt; shipping companies halting Hormuz transits; IRGC on maximum combat alert; Iran vows unprecedented response; Hormuz recovery progress reversed (transits dropping back from 30/day toward 15/day); IEA expected to reactivate strategic reserve guidance; prior context: Brent was ~$76/bbl on June 20 (−8% weekly) as Hormuz backlog cleared + 20+ tanker transits on June 20 (CNBC); June 19: UKMTO 2026-041 lifted; JMIC downgraded threat "Severe"→"Substantial"; 3 Saudi VLCCs transit Hormuz (Kpler); Goldman Sachs Q4 forecast cut to $80/bbl pre-strike — now reversed on escalation (Wikipedia — United States strikes on Iranian nuclear sites; ASIL; CNBC; CBS News; Al Jazeera, June 21)',
  },
};
