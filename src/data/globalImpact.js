...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'Israel', flag: 'il', pct: -5.8, costBn: 26, note: 'Mobilization + Lebanon ops + reconstruction; Lebanon ceasefire extended 45 days (to ~July 1) — IDF continues strikes; Lebanon toll 3,244 killed, 9,777 wounded (updated May 27 afternoon); IDF expands beyond "yellow line"; Nabatieh city evacuated — civil defense destroyed, strike near hospital; 31 killed in afternoon strikes (Burj al-Shamali 14, Maarakeh 6, Kawthariyat al-Riz 5, Habbush 4, Salaa 2); Hezbollah drones infiltrate northern Israel — no injuries' },
  ...
  oil: {
    ...
    note: 'Brent ~$99/bbl (stabilizing); WTI ~$92/bbl; Iranian delegation returned from Doha — Rubio: deal needs "several more days"; Iran: no deal "imminent"; $24B frozen assets at stake (released only after Hormuz reopens); IDF strikes kill 31 in Lebanon this afternoon (Burj al-Shamali 14, Maarakeh 6, others) — Lebanon toll 3,244/9,777; Nabatieh evacuated; India confirms 10 sailors released from Iran; war-risk insurance still 8× pre-crisis; PGSA operating; UKMTO 2026-041 in effect; IEA: "largest supply disruption in history"; Pentagon talks May 29',
  },
};
