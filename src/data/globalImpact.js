...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'GCC', flag: 'sa', pct: -3.8, costBn: 64, note: 'GDP recovery underway as Hormuz reopens; ~$58B infrastructure damage (80 energy facilities struck); UAE exports restored to 3.9 mbd (TradingEconomics); total daily Hormuz flows at ~9.5 mbd; Saudi Ras Tanura at full loading capacity; ADNOC, KNPC at full export capacity; Brent ~$56–59/bbl (below pre-war level); GCC airline routes restoring; Jebel Ali port congestion clearing; Bab al-Mandab fully open (Houthi ceasefire Day 11 — 23rd quiet day) (Al Jazeera; CNBC; TradingEconomics; July 5)' },
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $29B+ direct military cost (Military Times May 12); Moody\'s: $100B household cost (~$750/household); independent economists: $630B–$1T total; US gas prices ~$2.76–2.86/gal (4-year low, continuing to fall — lowest in 4 years); Hormuz transits at ~64/day; Rome 60-day follow-on talks Day 2 session underway; CENTCOM escort operations concluded post-MOU; $6B Iranian assets goods-purchase mechanism active via Doha talks; Iran/US/Lebanon High Level Committee established June 30; US-Iran de-confliction cell active via Qatar and Pakistan (Reuters; CBS News; GlobalSecurity; July 5)' },
  ...
  oil: {
    preWar: 68, current: 57, peak: 126, forecast: 80,
    note: 'Brent ~$56–59/bbl (ceasefire Day 12; well below pre-war $68 — 56%+ below $126 peak) — Hormuz transits ~64/day; oil flows ~9.5 mbd; Bab al-Mandab open (Houthi ceasefire Day 11 — 23rd quiet day); US gas prices ~$2.76–2.86/gal (4-year low, continuing to fall); IAEA DG Grossi completing Day 9 in Tehran — forensic review maintaining access at Fordow/Natanz/Isfahan; Rome 60-day follow-on talks Day 2; Goldman Sachs Q4 2026 forecast $80/bbl; IEA projects ~1.5 mbd global surplus by Q3 2026; Day 11: ~$58–61; Day 10: ~$60–63; Day 9: ~$62–65; Day 8: ~$64–66; Day 7: ~$66–68; Day 6: ~$67–68; Day 5: ~$68–69; June 26: $72; June 25: ~$74–76; June 23: ~$77.5; June 21 spike: ~$90 on US nuclear strikes; down 56%+ from $126 peak (TradingEconomics; CNBC; Goldman Sachs; IEA; July 5)',
  },
};
