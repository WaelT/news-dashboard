...
export const globalImpact = {
  updated: '2026-06-20',
  gdpImpact: [
    { region: 'Iran', flag: 'ir', pct: -22.0, costBn: 0, note: 'Economy near-collapse; IMF forecast: GDP −6.1% for 2026, inflation 68.9%; oil exports halted; $24B frozen assets at stake; June 15 (Day 108): DEAL COMPLETE — Trump announces US-Iran deal "Now Complete", authorizes end to US naval blockade; Iran Deputy FM Gharibabadi confirms deal; formal signing June 19 in Switzerland; oil and some financial sanctions to be lifted under MOU; 60-day follow-on talks on nuclear program, remaining sanctions, proxy support; Iran economy expected to begin recovery once Hormuz reopens and sanctions lift; Brent ~$81/bbl (RFERL, PBS News, NBC News, CBS News, Al Jazeera, June 15)' },
  ...
  oil: {
    preWar: 68, current: 76, peak: 126, forecast: 80,
    note: 'Brent ~$76/bbl (June 20, Day 113) — heading for ~8% weekly decline as Hormuz backlog clears; Israel-Hezbollah ceasefire renewed June 20 after overnight fighting (21 Lebanese killed, 4 IDF); Bürgenstock nuclear follow-on talks canceled — Iran demands IDF withdraw from Lebanon before talks begin; next round of nuclear talks to be held in Rome; 20+ tankers transit Hormuz on Saturday June 20 — highest single-day count since March 1 (CNBC); Goldman Sachs: Gulf flows already risen to 11 mbd across all routes; IEA strategic reserve drawdowns expected to halt as Hormuz normalizes; 520+ vessels still stranded (backlog clearance expected within 10–15 days); June 19: UKMTO 2026-041 lifted; JMIC downgraded Hormuz threat "Severe"→"Substantial"; 3 Saudi VLCCs transit Hormuz (Kpler); Goldman Sachs Q4 2026 Brent forecast $80/bbl — expects Gulf crude exports at pre-war levels by end of July 2026; June 15: DEAL COMPLETE — Trump announces deal "Now Complete", authorizes end to US naval blockade (PBS News, CNBC, CBS News, Al Jazeera, Goldman Sachs, June 19–20)',
  },
};
