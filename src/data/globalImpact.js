...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: '~$1.1B/day military; May 19: no new kinetic exchange (3rd consecutive day); Trump signals 20-year enrichment suspension offer (Times of Israel); Pakistan mediating; US 5 conditions still on table; Brent ~$107.71/bbl (easing from $111 spike); gas $4.53/gal' },
  ...
  oil: {
    ...
    note: 'Brent ~$107.71/bbl (May 18 close, countryeconomy.com) — easing from $111.19 spike after Trump signals 20-year enrichment flexibility (Times of Israel, May 19); no new kinetic exchange 3rd consecutive day; IEA: Hormuz disruption is "largest supply disruption in history of global oil market"; Aramco CEO: market won\'t normalize until 2027 if Hormuz closed past mid-June; Lebanon toll crosses 3,000',
  },
};
