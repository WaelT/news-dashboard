...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: '~$1.1B/day military; May 20: no new kinetic exchange (4th consecutive day); Trump called off scheduled May 19 Iran strike after GCC leaders (MBS, MBZ, Emir Tamim) intervened — military on standby "on a moment\'s notice"; Israel readying nuclear site strike if talks fail (Times of Israel/CNN); Iran conveying updated position to Pakistan; Brent ~$108–110/bbl (easing on deal hopes); gas $4.53/gal' },
  ...
  oil: {
    ...
    note: 'Brent ~$108–110/bbl (May 20) — easing from $111.19 spike on deal hopes; Trump calls off scheduled May 19 Iran strike after GCC leaders intervene (May 18); 4th consecutive day no new kinetic exchange; IEA: Hormuz disruption is "largest supply disruption in history of global oil market"; Aramco CEO: market won\'t normalize until 2027 if Hormuz closed past mid-June; Lebanon toll 3,020+ killed; Israel readying nuclear site strike if talks fail',
  },
};
