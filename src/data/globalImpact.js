...
export const globalImpact = {
  updated: '2026-05-27',
  gdpImpact: [
    { region: 'Iran', flag: 'ir', pct: -22.0, costBn: 0, note: 'Economy near-collapse; oil exports halted; PGSA collecting Hormuz transit fees (up to $2M/ship in CNY); Kharg Island ~71 sq km oil slick (~80,000 bbls); drone production already resuming (CIA, May 21); ~50% drone capability intact; ~2/3 missile launchers survived; Russia + China reconstitution support; internet partially restored after 88-day blackout (May 27, NetBlocks); FM Araghchi + Ghalibaf returned from Doha May 27; Rubio: deal "work in progress" — "disagreements over a word, a sentence"' },
    { region: 'Israel', flag: 'il', pct: -5.8, costBn: 26, note: 'Mobilization + Lebanon ops + reconstruction; Lebanon ceasefire extended 45 days (to ~July 1) — IDF continues strikes; Lebanon toll 3,213 killed, 9,737 wounded (updated May 27); IDF expands ground ops beyond "yellow line" in south Lebanon — Netanyahu orders deeper push to blunt Hezbollah drone threat; IDF struck 100+ Hezbollah sites overnight May 26–27; Mashghara Bekaa Valley strike kills 12' },
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: '~$1.1B/day military; May 26: CENTCOM destroys 2 IRGC mine-laying boats + strikes missile launch sites; May 27: ceasefire holds — Rubio says deal "work in progress" with "disagreements over a word, a sentence"; no joint MOU announcement yet; Brent ~$99/bbl (stabilizing); gas ~$4.50/gal; Pentagon talks May 29; political talks June 2–3' },
  ...
  oil: {
    ...
    note: 'Brent ~$99/bbl (stabilizing; CNBC May 27 — holds after 3% surge on May 26 CENTCOM mine-layer strikes); WTI ~$92/bbl; Iranian delegation returns from Doha May 27 — no joint MOU announcement; Rubio: deal "work in progress", "disagreements over a word, a sentence"; ceasefire holds 2nd day since May 25 violation; Lebanon toll 3,213 killed / 9,737 wounded (updated); Iran internet partially restored after 88-day blackout; IDF expands beyond "yellow line" in Lebanon; war-risk insurance still 8× pre-crisis; PGSA operating; UKMTO 2026-041 in effect; IEA: "largest supply disruption in history"; Pentagon talks May 29',
  },
};
