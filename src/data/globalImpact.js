...
export const globalImpact = {
  ...
  oil: {
    preWar: 68, current: 78, peak: 126, forecast: 80,
    note: 'Brent ~$78/bbl (June 19, Day 112) — post-signing low; MOU formally signed at Burgenstock by VP Vance (US) and Iran Parliament Speaker Ghalibaf; UKMTO 2026-041 lifted; JMIC downgraded Hormuz threat "Severe"→"Substantial"; 3 Saudi VLCCs (Kpler confirmed) transit Hormuz — first Saudi tanker movements since February 28; oil flow ~5.1 mbd (up from ~4.0 mbd); Goldman Sachs Q4 2026 Brent forecast: $80/bbl — expects Persian Gulf crude exports at pre-war levels by end of July 2026; IEA strategic reserve drawdowns expected to halt post-signing; 550+ vessels still stranded (backlog clearance expected 10–15 days); June 15 (Day 108): DEAL COMPLETE — Trump announces deal "Now Complete", authorizes end to US naval blockade; formal signing June 19 in Switzerland; EIA/IEA forecast Brent to stabilize near $75–80 once Hormuz fully reopens (Swiss FM, VP Vance press brief, Kpler, JMIC, CNBC, Al Jazeera, Goldman Sachs, June 17–19)',
  },
};
