...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $25B direct military cost; independent economists: $630B–$1T total (Al Jazeera Apr 30; Harvard Kennedy School); ~$1.1B/day; CENTCOM disables 5th blockade-runner (M/V Lian Star) in Gulf of Oman May 31 — Hellfire missile; CENTCOM: 118 vessels redirected, 5 disabled total (June 1); Hegseth Shangri-La: "blockade still in place, able to recommence"; 60-day MOU still awaiting Trump/Khamenei sign-off (Day 93); Brent ~$91/bbl; gas ~$4.45/gal; Pentagon Lebanon political talks June 2–3' },
  ...
  oil: {
    ...
    note: 'Brent ~$91/bbl (June 1); −17% for May — biggest monthly decline since 2020; WTI ~$88/bbl; CENTCOM: 118 vessels redirected, 5 disabled (June 1); ceasefire holds Day 93 — Iran front; Netanyahu orders IDF to expand Lebanon ground op — IDF crosses Litani River toward Nabatieh; Hezbollah fires 25+ projectiles at N. Israel (Karmiel, Safed); Lebanon toll 3,412/10,269 (June 1); 60-day MOU unsigned — Trump/Khamenei sign-off pending; PGSA operational; UKMTO 2026-041 in effect; war-risk insurance still 8× pre-crisis; Pentagon Lebanon political talks June 2–3',
  },
};
