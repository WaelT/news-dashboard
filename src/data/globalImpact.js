...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $25B direct military cost; independent economists: $630B–$1T total (Al Jazeera Apr 30; Harvard Kennedy School); ~$1.1B/day; CENTCOM: 118 vessels redirected, 5 disabled total; June 5: Rubio tells Congress new Supreme Leader Mojtaba Khamenei is "increasingly engaged" — most positive characterization of Iranian leadership disposition since ceasefire began; Trump says deal reachable "within a week"; 60-day MOU still unsigned; US House War Powers resolution passed 215-208 (June 3); gas ~$4.52/gal' },
  ...
  oil: {
    ...
    note: 'Brent ~$97/bbl (June 5; stable range $96–101 since June 1 suspension surge); WTI ~$93/bbl; June 5 (Day 98): ceasefire holds — no new kinetic exchanges on Iran front; Trump says deal reachable "within a week"; Rubio tells Congress new Supreme Leader Khamenei "increasingly engaged"; 60-day MOU (Hormuz reopen/no tolls + blockade lift + sanctions waivers) still unsigned; US-brokered fragile Lebanon partial halt (Israel holds off Dahiyeh strikes; Hezbollah not attacking Israel); Lebanon toll 3,516/10,674 (Wikipedia, June 4 scrape); war-risk insurance still 8× pre-crisis; shipping executives unwilling to transit without definitive peace agreement; PGSA operational; UKMTO 2026-041 in effect (Fortune, Al Jazeera, NPR, Times of Israel, CENTCOM, CNN, June 5)',
  },
};
