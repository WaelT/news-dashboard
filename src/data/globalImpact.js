...
export const globalImpact = {
  ...
  gdpImpact: [
    ...
    { region: 'GCC', flag: 'sa', pct: -3.8, costBn: 64, note: 'GDP recovery underway as Hormuz reopens; ~$58B infrastructure damage (80 energy facilities struck); IRGC fired missiles at Qatari LNG tanker Al Rekayyat + Saudi crude tanker in Hormuz July 7 — engine room fire, zero casualties, UKMTO confirmed; Qatar dispatched diplomatic protest; Saudi Arabia at 90% pre-war export baseline but export operations pausing pending security reassessment; UAE exports 3.9 mbd; Hormuz oil flows ~9.8 mbd (down from 10.2 mbd pre-attack); Brent ~$72–74 (brief spike on tanker attacks; OPEC+ +188K bpd capping upside); GCC airline routes restoring; Bab al-Mandab fully open (Houthi ceasefire Day 14 — 26th quiet day); Rome talks still paused for funeral week (Al Jazeera; The National; UKMTO; CNBC; July 8)' },
    ...
    { region: 'US', flag: 'us', pct: -0.5, costBn: 70, note: 'Pentagon: $29B+ direct military cost (Military Times May 12); Moody\'s: $100B household cost (~$750/household); independent economists: $630B–$1T total; Brent ~$72–74 (brief spike after IRGC struck Qatari LNG tanker Al Rekayyat + Saudi crude tanker in Hormuz July 7; OPEC+ +188K bpd still capping upside); Hormuz transits ~65/day (down from 70/day due to operator caution after tanker attacks); Rome 60-day follow-on talks still paused (Khamenei funeral Day 5 of 6-day ceremony) — expected to resume ~July 14; IAEA-Iran inspection standoff: Qalibaf blocks IAEA access to Fordow/Natanz/Isfahan under parliamentary law; IAEA DG Grossi: inspections "going to happen"; deadlock at US-Iran de-confliction cell; US-Iran de-confliction cell active via Qatar and Pakistan; CENTCOM escort operations re-evaluating post-tanker attack (IAEA; Reuters; Al Jazeera; The National; UKMTO; July 8)' },
  ...
  oil: {
    preWar: 68, current: 73, peak: 126, forecast: 80,
    note: 'Brent ~$72–74 July 8 (brief spike after IRGC missile strikes on Qatari LNG tanker Al Rekayyat + Saudi crude tanker in Strait of Hormuz July 7; Al Rekayyat engine room fire, zero casualties per UKMTO; OPEC+ +188K bpd still exerting downward pressure; ceasefire nominally in force but strained; Hormuz transits dipped to ~65/day as operators exercise caution; JMIC: Hormuz threat remains "Substantial"); Day 14 close: ~$72.12; Day 13: ~$69–72; Day 12: ~$69–72; Day 11: ~$72–74; Day 10: ~$60–63; Day 9: ~$58–61; June 26: $70; June 23: ~$77.5; June 21 spike: ~$90 on US nuclear strikes; down from $126 peak (TradingEconomics; CNBC; Al Jazeera; The National; UKMTO; Vantage Markets; July 8)',
  },
};
