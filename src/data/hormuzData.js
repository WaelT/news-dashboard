...
//          Kpler (May 7 2026), CNBC (May 6-14 2026), NBC News (May 6-14 2026),
//          CENTCOM (May 7-14 2026), CBS News (May 8-14 2026), PBS NewsHour (May 9-14 2026),
//          Al Jazeera (May 8-14 2026), UPI/GlobalSecurity (May 8 2026), Al-Monitor/ITV (May 9 2026),
...
//          AP/Reuters (May 13-14 2026 — Trump-Xi summit Days 1-2; Israel-Lebanon talks Round 3 open Washington)
export const hormuzData = {
  ...
  disruptions: [
    ...
    {
      country: 'Asia',
      detail: 'Japan, South Korea, India activating IEA strategic reserves; LNG spot price $43/MMBtu; South Korea 70% Hormuz-dependent; India diverting purchases to West Africa and Americas; ~170M barrels stranded on 166 tankers (Kpler May 7); Brent ~$106 (May 14) as Trump-Xi summit enters Day 2 and revised US counter-proposal delivered to Iran; Saudi Aramco CEO Amin Nasser warns oil market will not normalize until 2027 if Hormuz remains closed past mid-June — conflict has destroyed ~880M barrels of supply (100M/week); global inventories at 8-year low (Goldman Sachs); US gas price $4.46/gal; first Qatari LNG tanker transited Hormuz May 11 (MarineTraffic AIS); May 10 saw 17 vessels transit (13 in, 4 out) — uptick from 6/day average since May 4; UK HMS Dragon + French carrier strike group pre-positioning for post-ceasefire escort; Trump-Xi summit Day 2 in Beijing May 14 — Xi signals readiness to relay Hormuz message to Tehran; China buying ~$16B/yr Iranian crude targeted by US Treasury (12 entities sanctioned May 12); Asian buyers cautiously optimistic on summit outcome; Israel-Lebanon round 3 talks open May 14 in Washington (Ron Dermer + Simon Karam); May 17 ceasefire deadline now 3 days away',
    },
  ],
};
