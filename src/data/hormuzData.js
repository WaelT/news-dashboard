...
export const hormuzData = {
  ...
  disruptions: [
    ...
    {
      country: 'Asia',
      detail: 'Japan, South Korea, India activating IEA strategic reserves; LNG spot price $43/MMBtu; South Korea 70% Hormuz-dependent; India diverting purchases to West Africa and Americas; ~170M barrels stranded on 166 tankers (Kpler May 7); Brent ~$101 (May 11) after Trump rejected Iran MoU as "TOTALLY UNACCEPTABLE" — deal at impasse; global inventories at 8-year low (Goldman Sachs); US gas price $4.46/gal; strait near-closed since May 4 — only ~6 vessels/day average vs pre-war 90/day; UK HMS Dragon + French carrier strike group pre-positioning for post-ceasefire escort mission; cargo vessel struck near Mesaieed port Qatar (May 10 drone attack)',
    },
  ],
};
