...
//          Kpler (May 7 2026), CNBC (May 6-10 2026), NBC News (May 6-10 2026),
//          CENTCOM (May 7-10 2026), CBS News (May 8-10 2026), PBS NewsHour (May 9-10 2026),
//          Al Jazeera (May 8-10 2026), UPI/GlobalSecurity (May 8 2026), Al-Monitor/ITV (May 9 2026)
export const hormuzData = {
  ...
  disruptions: [
    ...
    {
      country: 'Asia',
      detail: 'Japan, South Korea, India activating IEA strategic reserves; LNG spot price $43/MMBtu; South Korea 70% Hormuz-dependent; India diverting purchases to West Africa and Americas; ~170M barrels stranded on 166 tankers (Kpler May 7); Brent ~$101 (May 10) as Iran MoU response still pending; global inventories at 8-year low (Goldman Sachs); US gas price $4.46/gal; strait near-closed since May 4 — only ~6 vessels/day average vs pre-war 90/day; UK HMS Dragon + French carrier strike group pre-positioning for post-ceasefire escort mission',
    },
  ],
};
