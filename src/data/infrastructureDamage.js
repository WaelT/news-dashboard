...
export const infrastructureDamage = {
  ...
  categories: [
    ...
    { id: 'command', label: 'Command & Control', destructionPct: 65, detail: 'Multiple IRGC HQs struck; 7+ senior IRGC commanders killed; IDF killed senior Hezbollah commander in Beirut (May 7); CENTCOM struck 11,000+ targets in Iran total; US delivers revised counter-proposal via Pakistan (May 14); Trump-Xi summit Day 2 May 14 in Beijing; May 17 ceasefire deadline 3 days away', color: '#c084fc' },
  ],
};
