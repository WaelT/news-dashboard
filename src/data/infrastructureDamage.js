...
export const infrastructureDamage = {
  ...
  categories: [
    ...
    { id: 'command', label: 'Command & Control', destructionPct: 65, detail: 'Multiple IRGC HQs struck; 7+ senior IRGC commanders killed; IDF killed senior Hezbollah commander in Beirut (May 7); CENTCOM struck 11,000+ targets in Iran total; Trump-Xi summit concludes May 15 — Hormuz "must remain open" agreed; Trump extends Iran ceasefire indefinitely May 16 (no new deadline); Israel-Lebanon ceasefire extended 45 days (~July 1); PGSA toll plan announced May 16; drone strikes Barakah Nuclear Plant (UAE, Arab world\'s only nuclear plant) generator May 17 — IAEA DG Grossi "grave concern"; NYT: US-Israel in "intense preparations" for renewed strikes on Iran (May 17); May 18: Trump calls off scheduled May 19 Iran strike after GCC leaders (MBS, MBZ, Emir Tamim) intervene — military told to remain ready "on a moment\'s notice"; May 20: 4th consecutive day no new kinetic exchange; Israel readying nuclear site strike if talks fail (Times of Israel/CNN); CENTCOM commander dismisses reports Iran retains most missile/drone arsenal', color: '#c084fc' },
  ],
};
