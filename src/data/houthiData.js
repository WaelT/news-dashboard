...
export const houthiData = {
  updated: '2026-06-19',
  status: 'MONITORING — JUNE 19 (DAY 112): MOU FORMALLY SIGNED AT BURGENSTOCK BY VP VANCE (US) + GHALIBAF (IRAN); 7TH CONSECUTIVE QUIET DAY — NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; 3 SAUDI VLCCS TRANSIT HORMUZ (KPLER DATA); JMIC DOWNGRADED HORMUZ THREAT "SEVERE"→"SUBSTANTIAL"; BRENT ~$78/BBL; HOUTHI FORMAL CEASEFIRE DECLARATION EXPECTED WITHIN 24–48H POST-SIGNING; MARAD ADVISORY 2026-006 STILL IN EFFECT PENDING FORMAL HOUTHI STATEMENT',
  babAlMandab: {
    globalTradePct: 15,
