...
export const houthiData = {
  updated: '2026-06-24',
  status: 'MONITORING — JUNE 24 (DAY 117): 12TH CONSECUTIVE QUIET DAY — CEASEFIRE DAY 1 IN EFFECT; IRAN CEASED HOSTILITIES MIDNIGHT JUNE 24 (DOHA/TEHRAN TIME); ISRAEL TO FOLLOW 12 HOURS LATER; NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; HOUTHI SPOKESMAN AL-BUKHAITI STATEMENT ON FORMAL POSTURE CHANGE IMMINENT; MARAD ADVISORY 2026-006 EXPECTED TO BE LIFTED POST-FORMAL HOUTHI DECLARATION; BRENT ~$76/BBL; HOUTHI FORMAL CEASEFIRE DECLARATION EXPECTED WITHIN 24H',
  babAlMandab: {
    globalTradePct: 15,
