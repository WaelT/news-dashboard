...
export const houthiData = {
  updated: '2026-06-21',
  status: 'MONITORING — JUNE 21 (DAY 114): 9TH CONSECUTIVE QUIET DAY — NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; US STRIKES FORDOW, NATANZ, ISFAHAN NUCLEAR FACILITIES (B-2 BOMBERS + GBU-57 + TOMAHAWKS); IRAN VOWS "UNPRECEDENTED RESPONSE"; IRGC ON MAXIMUM ALERT; HOUTHI SPOKESMAN AL-BUKHAITI SIGNALS "WILL ASSESS AND RESPOND AS APPROPRIATE" — FORMAL CEASEFIRE DECLARATION NOW UNCERTAIN; MARAD ADVISORY 2026-006 STILL IN EFFECT; DEAL FRAMEWORK IN DOUBT',
  babAlMandab: {
    globalTradePct: 15,
