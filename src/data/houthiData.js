...
export const houthiData = {
  updated: '2026-06-23',
  status: 'MONITORING — JUNE 23 (DAY 116): 11TH CONSECUTIVE QUIET DAY — NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; IRAN LAUNCHED ~14 BALLISTIC MISSILES AT AL UDEID AIR BASE QATAR (13 INTERCEPTED, 1 IMPACTS, NO CASUALTIES); TRUMP ANNOUNCES IRAN-ISRAEL CEASEFIRE TO TAKE EFFECT MIDNIGHT JUNE 24 — QATAR MEDIATED; BRENT ~$77.5/BBL; HOUTHI SPOKESMAN AL-BUKHAITI EXPECTED TO ANNOUNCE FORMAL POSTURE CHANGE FOLLOWING CEASEFIRE DECLARATION; MARAD ADVISORY 2026-006 MAY BE LIFTED POST-CEASEFIRE; HOUTHI FORMAL CEASEFIRE DECLARATION EXPECTED WITHIN 24–48H',
  babAlMandab: {
    globalTradePct: 15,
