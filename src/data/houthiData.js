...
export const houthiData = {
  updated: '2026-05-22',
  status: 'ACTIVE — MAY 22: 6TH CONSECUTIVE CEASEFIRE DAY; NO NEW KINETIC EXCHANGE; US-IRAN TALKS CONTINUING VIA PAKISTAN; BRENT ~$104.52/BBL (+1.89%; TRADINGECONOMICS); WTI ~$99.50/BBL; PGSA OPERATIONAL; UKMTO 2026-041 IN EFFECT; PENTAGON TALKS MAY 29',
  babAlMandab: {
    globalTradePct: 15,
