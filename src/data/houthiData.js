...
export const houthiData = {
  updated: '2026-06-20',
  status: 'MONITORING — JUNE 20 (DAY 113): 8TH CONSECUTIVE QUIET DAY — NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; ISRAEL-HEZBOLLAH CEASEFIRE RENEWED JUNE 20 (PBS NEWS); BÜRGENSTOCK NUCLEAR TALKS CANCELED — IRAN DEMANDS IDF WITHDRAWAL FROM LEBANON; NEXT US-IRAN NUCLEAR TALKS TO BE IN ROME; 20+ TANKERS TRANSIT HORMUZ (HIGHEST SINCE MARCH 1); BRENT ~$76/BBL (−8% WEEKLY); HOUTHI FORMAL CEASEFIRE DECLARATION EXPECTED ONCE LEBANON COMPONENT ADDRESSED IN 60-DAY FOLLOW-ON TALKS; MARAD ADVISORY 2026-006 STILL IN EFFECT',
  babAlMandab: {
    globalTradePct: 15,
