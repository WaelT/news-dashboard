...
export const houthiData = {
  updated: '2026-06-28',
  status: 'CEASEFIRE — JUNE 28 (DAY 121): HOUTHI CEASEFIRE DAY 4 — 16TH CONSECUTIVE QUIET DAY; NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; MARAD ADVISORY 2026-006 LIFTED; BAB AL-MANDAB FULLY OPEN — NORMAL SHIPPING OPERATIONS AT FULL COMMERCIAL PACE; BRENT ~$68–69/BBL (AT PRE-WAR LEVEL); US GAS PRICES ~$3.10–3.15/GAL (4-YEAR LOW); 60-DAY FOLLOW-ON TALKS ADVANCING TOWARD ROME VENUE — HOUTHI PROXY SUPPORT COMPONENT ON AGENDA; IAEA DG GROSSI IN TEHRAN DAY 2 OF NUCLEAR INSPECTION DISCUSSIONS',
  babAlMandab: {
    globalTradePct: 15,
