...
export const houthiData = {
  updated: '2026-06-22',
  status: 'MONITORING — JUNE 22 (DAY 115): 10TH CONSECUTIVE QUIET DAY — NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; IRAN ON MAXIMUM ALERT FOLLOWING JUNE 21 NUCLEAR STRIKES; IRAN SUPREME NATIONAL SECURITY COUNCIL DELIBERATING RESPONSE; VP VANCE MET IRANIAN OFFICIALS FACE-TO-FACE IN SWITZERLAND JUNE 21 — "GREAT PROGRESS" PER VANCE; TRUMP THREATENED "HIT IRAN VERY HARD AGAIN"; UNSC EMERGENCY SESSION; HOUTHI SPOKESMAN AL-BUKHAITI SILENT — POSTURE EXPECTED TO CHANGE ONCE IRAN ISSUES FORMAL RESPONSE DIRECTIVE; MARAD ADVISORY 2026-006 STILL IN EFFECT',
  babAlMandab: {
    globalTradePct: 15,
