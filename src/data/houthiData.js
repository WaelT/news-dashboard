...
export const houthiData = {
  updated: '2026-06-29',
  status: 'CEASEFIRE — JUNE 29 (DAY 122): HOUTHI CEASEFIRE DAY 5 — 17TH CONSECUTIVE QUIET DAY; NO CONFIRMED HOUTHI ATTACKS SINCE MV VERBENA JUNE 13; MARAD ADVISORY 2026-006 LIFTED; BAB AL-MANDAB FULLY OPEN — ALL MAJOR SHIPPING LINES RESTORED RED SEA SCHEDULES AT PRE-WAR OPERATIONAL TEMPO; BRENT ~$67–68/BBL (AT/BELOW PRE-WAR LEVEL); US GAS PRICES ~$3.08–3.12/GAL (4-YEAR LOW); ROME 60-DAY FOLLOW-ON TALKS FORMAL AGENDA ADVANCING; IAEA DG GROSSI COMPLETING DAY 3 IN TEHRAN; HOUTHI PROXY SUPPORT ON ROME AGENDA',
  babAlMandab: {
    globalTradePct: 15,
